                ...
                <table class="w-full whitespace-nowrap">
                    <tbody>
                        ...
                        <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded">
                            ...
                            <td class="">
                                <div class="flex items-center pl-5">
                                    <p class="text-base font-medium leading-none text-gray-700 mr-2">Development Phase
                                        1</p>
                                </div>
                            </td>
                            <td class="pl-24"></td>
                        ...
                        <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded">
                            ...
                            <td class="">
                                <div class="flex items-center pl-5">
                                    <p class="text-base font-medium leading-none text-gray-700 mr-2">Vue integration
                                    </p>
                                </div>
                            </td>
                            <td class="pl-24">
