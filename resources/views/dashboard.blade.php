                        ...
                        <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded">
                            ...
                            <td class="">
                                <div class="flex items-center pl-5">
                                    <p class="text-base font-medium leading-none text-gray-700 mr-2">タスク名
                                    </p>
                                </div>
                            </td>
                            <td class="">
                                <div class="flex items-center pl-5">
                                    <p class="text-base font-medium leading-none text-gray-400 mr-2">場所
                                    </p>
                                </div>
                            </td>
                            <td class="pl-24">
                            ...
                            <td class="pl-5">
                                <div class="flex items-center">
                                    ...
                                    <p class="text-sm leading-none text-gray-600 ml-2">開始日時</p>
                                </div>
                            </td>
                            <td class="pl-0">
                                <button
                            ...
                            <td class="pl-0">
                                <button
                                    class="focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none text-gray-600 py-3 px-5 bg-gray-100 rounded hover:bg-gray-200 focus:outline-none">変更</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
